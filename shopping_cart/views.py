...
@login_required()
def add_to_cart(request, **kwargs): #from kwargs, we can get the stuff out from the url , here used it to get item_id, could've also simply taken item_id directly as argument here
